...
define([], function () {
    ...
    var LogicGateDecoratorConnections,
    ...
    LogicGateDecoratorConnections = function () {
    };

    LogicGateDecoratorConnections.prototype.setConnectionAreaDefaults = function (attr) {
        CONN_AREA_DEFAULTS = attr;
    };

    LogicGateDecoratorConnections.prototype._discoverCustomConnectionAreas = function (svgElement) {
    ...
    return LogicGateDecoratorConnections;
});
