...
define([
    ...
    var LogicGateDecoratorPorts,
        PORT_HEIGHT = 13,   //must be same as LogicGateDecorator.scss 's $port-height actually used more like width
        PORT_WIDTH = 5,
        DEFAULT_SVG_DEFAULT_HEIGHT = 50;

    LogicGateDecoratorPorts = function () {
        DecoratorWithPortsBase.apply(this, []);
    };

    _.extend(LogicGateDecoratorPorts.prototype, DecoratorWithPortsBase.prototype);

    LogicGateDecoratorPorts.prototype._PORT_HEIGHT = PORT_HEIGHT;

    LogicGateDecoratorPorts.prototype._updatePorts = function () {
    ...
    LogicGateDecoratorPorts.prototype._fixPortContainerPosition = function (xShift) {
    ...
    LogicGateDecoratorPorts.prototype.renderPort = function (portId) {
        return new SVGPort({
            id: portId,
            logger: this.logger,
    ...
    LogicGateDecoratorPorts.prototype._updatePortPositions = function () {
        var leftPorts = [],
            rightPorts = [],
            i,
            RIGHT_POS_X = 300,
    ...
    LogicGateDecoratorPorts.prototype._updatePort = function (portId) {
    ...
    LogicGateDecoratorPorts.prototype.showPortTitle = function (show) {
        if (show === true) {
    ...
    return LogicGateDecoratorPorts;
});
