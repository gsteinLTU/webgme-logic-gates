...
define([
    ...
    LogicGateDecoratorCore = function () {
        DecoratorWithPortsAndPointerHelpers.apply(this, []);
        this.svgCache = SVG_CACHE;
    };

    _.extend(LogicGateDecoratorCore.prototype, DecoratorWithPortsAndPointerHelpers.prototype);

    LogicGateDecoratorCore.prototype._initializeVariables = function (params) {
        this.name = '';
        this.formattedName = '';
        this.$name = undefined;
    ...
    LogicGateDecoratorCore.prototype.doSearch = function (searchDesc) {
    ...
    LogicGateDecoratorCore.prototype._renderContent = function () {
    ...
    LogicGateDecoratorCore.prototype._update = function () {
    ...
    LogicGateDecoratorCore.prototype._updateColors = function () {
    ...
    LogicGateDecoratorCore.prototype._getNodeColorsFromRegistry = function () {
    ...
    LogicGateDecoratorCore.prototype._updateName = function () {
    ...
    LogicGateDecoratorCore.prototype._updateAbstract = function () {
        var client = this._control._client,
            nodeObj = client.getNode(this._metaInfo[CONSTANTS.GME_ID]);
    ...
    LogicGateDecoratorCore.prototype._updateSVGContent = function () {
        var client = this._control._client,
            nodeObj = client.getNode(this._metaInfo[CONSTANTS.GME_ID]),
            svgContent;
    ...
    LogicGateDecoratorCore.prototype._updateExtras = function () {
        //Can be overridden for custom functionality
    };

    /***** PORT FUNCTIONALITY *****/
    //Overridden in LogicGateDecorator.Ports.js
    LogicGateDecoratorCore.prototype._updatePorts = function () {
        //If no ports in model, does nothing
    };

    LogicGateDecoratorCore.prototype._fixPortContainerPosition = function () {
        //If no ports in model, does nothing
    };

    /***** CONNECTION FUNCTIONALITY *****/
    //Overridden in LogicGateDecorator.Connection.js
    LogicGateDecoratorCore.prototype._discoverCustomConnectionAreas = function () {
        //If no connections in model, does nothing
    };

    //Overridden in LogicGateDecorator.Connection.js
    LogicGateDecoratorCore.prototype._generateConnectors = function () {
        //If no connections in model, does nothing
    };

    LogicGateDecoratorCore.prototype._updateIsReplaceable = function () {
